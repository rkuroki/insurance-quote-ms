...
@Component
@Slf4j
public class InsurancePolicyCreationSubImpl implements InsurancePolicyCreationSub {

    private InsuranceQuoteService quoteService;

    public InsurancePolicyCreationSubImpl(InsuranceQuoteService quoteService) {
